...
import {escapeRegExp} from '@asvla/workbox-build/build/lib/escape-regexp';
import {replaceAndUpdateSourceMap} from '@asvla/workbox-build/build/lib/replace-and-update-source-map';
import {validateWebpackInjectManifestOptions} from '@asvla/workbox-build/build/lib/validate-options';
...
import {WebpackInjectManifestOptions} from '@asvla/workbox-build';
